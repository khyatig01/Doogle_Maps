...
public interface GraphADT<T> {
	 ...
	 *         the edge with the same weight was already in the graph with the graph
	 * @throws IllegalArgumentException if either sourceVertex or targetVertex or
	 *                                  both are not in the graph, or weight is < 0
	 ...
	 * @throws NullPointerException if either sourceVertex or targetVertex or both
	 *                              are null
	 */
	...
	/**
	 * Returns the shortest path between startingVertex and destinationVertex. Uses
	 ...
	 *         vertex with data item startingVertex and vertex with data item
	 *         destinationVertex, including both startingVertex and
	 *         destinationVertex
	 */
	public List<T> shortestPath(T start, T end);

	/**
	 * Returns the cost of the path (sum over edge weights) between startingVertex
	 * and destinationVertex. Uses Dijkstra's shortest path algorithm to find the
	 * shortest path.
	 * 
	 * @param start the data item in the starting vertex for the path
	 * @param end   the data item in the destination vertex for the path
	 * @return the cost of the shortest path between vertex with data item
	 *         startingVertex and vertex with data item destinationVertex, including
	 *         both startingVertex and destinationVertex
	 */
